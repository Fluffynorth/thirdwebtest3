...
const App = () => {
  ...
  const App = () => {
    ...
    return (
      <ThirdwebProvider activeChain={Phoenix}>{/* {...} */}</ThirdwebProvider>
    );
  };
  console.log('👋 Address:', address);
  // Initialize our Edition Drop contract
  const editionDropAddress = '0x131B6c8067B18A6AD12dd482276121FF35211237';
  ...
  const { contract: token } = useContract(
    '0xAe8879c810cb8Ad2409B36f52FeaeC96EaEB0B5f',
    'token',
  );
  const { contract: vote } = useContract(
    '0x83FB325a7C94274E24E07cb7f6C5F16484fb9Cf7',
    'vote',
  );
...
/*  if (address && network?.[0].data.chain.id !== Phoenix) {
    return (
